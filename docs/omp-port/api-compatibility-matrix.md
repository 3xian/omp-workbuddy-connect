...
| `turn_start` | Supported in interactive and headless sessions | Dismiss command-scoped Widget and cancel pending detail refresh; do not occupy status line | `test/ui.test.mts`; typecheck plus parent/child-shaped headless emission |
